...
class Configuration:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            ingested_train_dir=os.path.join(ingested_data_dir,data_ingestion_config_info[DATA_INGESTION_TRAIN_DIR_KEY])

            ingested_test_dir=os.path.join(ingested_data_dir,data_ingestion_config_info[DATA_INGESTION_TEST_DIR_KEY])
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            artifact_dir=self.training_pipeline_config.artifact_dir
            data_validation_dir=os.path.join(artifact_dir,DATA_VALIDATION_ARTIFACT_DIR_NAME,self.time_stamp)

            data_validation_config_info=self.config_info[DATA_VALIDATION_CONFIG_KEY]

            schema_file_path=os.path.join(data_validation_dir,data_validation_config_info[DATA_VALIDATION_SCHEMA_DIR_KEY],
                                          data_validation_config_info[DATA_VALIDATION_SCHEMA_FILE_NAME_KEY])
            
            report_file_path=os.path.join(data_validation_dir,data_validation_config_info[DATA_VALIDATION_REPORT_FILE_NAME_KEY])

            report_page_file_path=os.path.join(data_validation_dir,data_validation_config_info[DATA_VALIDATION_REPORT_PAGE_FILE_NAME_KEY])
    ...
    def get_model_trainer_config(self)->ModelTrainerConfig:
        try:
            ...
            get_model_trainer_config_info=self.config_info[MODEL_TRAINER_CONFIG_KEY]

            trained_model_file_path=os.path.join(model_trainer_artifact_dir,get_model_trainer_config_info[MODEL_TRAINER_TRAINED_MODEL_DIR_KEY],
                                                 get_model_trainer_config_info[MODEL_TRAINER_TRAINED_MODEL_FILE_NAME_KEY])
    ...
    def get_training_pipeline_config(self)->TrainingPipelineConfig:
        try:
            ...
            artifact_dir = os.path.join(ROOT_DIR, training_pipeline_config_info[TRAINING_PIPELINE_NAME_KEY],
                                        training_pipeline_config_info[TRAINING_PIPELINE_ARTIFACT_DIR_KEY])
